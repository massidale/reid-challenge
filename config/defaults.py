...
_C.MODEL.EFFICIENTNET.MODEL_NAME = 'efficientnet-b0'  # Options: b0-b7
_C.MODEL.EFFICIENTNET.DROP_RATE = 0.2
_C.MODEL.EFFICIENTNET.DROP_CONNECT_RATE = 0.2
_C.MODEL.EFFICIENTNET.MEMORY_EFFICIENT_SWISH = False
_C.MODEL.EFFICIENTNET.BN_MOMENTUM = 0.1
_C.MODEL.EFFICIENTNET.BN_EPS = 1e-5
_C.MODEL.EFFICIENTNET.ACT_LAYER = 'swish'
_C.MODEL.EFFICIENTNET.NORM_LAYER = 'batch_norm'
_C.MODEL.EFFICIENTNET.PADDING_SAME = True
_C.MODEL.EFFICIENTNET.SE_REDUCTION = 4
_C.MODEL.EFFICIENTNET.SE_DROPOUT = 0.0
_C.MODEL.EFFICIENTNET.SE_ACT_LAYER = 'sigmoid'
_C.MODEL.EFFICIENTNET.SE_GATE_MIN = 0.0
_C.MODEL.EFFICIENTNET.SE_GATE_MAX = 1.0
_C.MODEL.EFFICIENTNET.SE_GATE_BIAS = 0.0
_C.MODEL.EFFICIENTNET.SE_GATE_SCALE = 1.0
_C.MODEL.EFFICIENTNET.SE_GATE_NORM = False
_C.MODEL.EFFICIENTNET.SE_GATE_ACT = 'sigmoid'
_C.MODEL.EFFICIENTNET.SE_GATE_INIT = 'zeros'
_C.MODEL.EFFICIENTNET.SE_GATE_BIAS_INIT = 'zeros'
_C.MODEL.EFFICIENTNET.SE_GATE_SCALE_INIT = 'ones'
_C.MODEL.EFFICIENTNET.SE_GATE_NORM_INIT = 'ones'
_C.MODEL.EFFICIENTNET.SE_GATE_ACT_INIT = 'sigmoid'
_C.MODEL.EFFICIENTNET.SE_GATE_BIAS_INIT = 'zeros'
_C.MODEL.EFFICIENTNET.SE_GATE_SCALE_INIT = 'ones'
_C.MODEL.EFFICIENTNET.SE_GATE_NORM_INIT = 'ones'
_C.MODEL.EFFICIENTNET.SE_GATE_ACT_INIT = 'sigmoid'
